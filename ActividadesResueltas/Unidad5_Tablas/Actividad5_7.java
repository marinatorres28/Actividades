...
/* Implementar la funcion: int [] sinRepetidos(int t[]),que construye y devuelve una tabla de longitud
   apropiada,con los elementos de t,donde se han eliminado los datos repetidos.
* */
public class Actividad5_7 {
    ...
    public static void buscarDuplicados (int tabla[]) {
        int duplicados[]=new int[0]; //creo una nueva tabla para almacenar los numeros sin duplicados
